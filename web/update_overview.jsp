...
<head>
    ...
    <link rel="stylesheet" href="image/update_over_view.css"/>
</head>
<body>
<div>
    ...
    <div class="box">
        ...
        <table class="ta">
            <tr class="tar">
                <td class="tad1">项目号:</td>
                <td class="tad2">${program.PNO}</td>

            </tr>
            <tr class="tar">
                <td class="tad1">项目名称:</td>
                <td class="tad2">
                    <div class="group">
                        <input type="text" value="${program.PNAME}" name="PNAME" required>
            ...
            <tr class="tar">
                <td class="tad1">项目类型:</td>
                <td class="tad2">
                    <div class="group">
                        <input type="text" value="${program.PTYPE}" name="PTYPE" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label></label>
                    </div>
            ...
            <tr class="tar">
                <td class="tad1">项目阶段:</td>
                <td class="tad2">
                    <div class="group">
                        <input type="text" value="${program.PTERM}" name="PTERM" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label></label>
                    </div>
            ...
            <tr class="tar">
                <td class="tad1">项目业主:</td>
                <td class="tad2">
                    <div class="group">
                        <input type="text" value="${program.POWNER}" name="POWNER" required>
                        <span class="highlight"></span>
                        <span class="bar"></span>
                        <label></label>
                    </div>
            ...
            <tr class="tar">
                <td class="tad1">项目所属集团:</td>
                <td class="tad2">
                <div class="group">
                    <input type="text" value="${program.PFIRM}" name="PFIRM" required>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label></label>
                </div>
        ...
        <button class="custom-btn btn-15" onclick="window.location.href='overview?id=${program.PNO}'"> 返  回 </button>
        </form>
    </div>
</body>
</html>
